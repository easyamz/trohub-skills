...
- Translate `riskLevel`/`similarity`/`score` fields into a short human summary (e.g. "High risk: 92% visual match to US Design Patent D0935924, filed 2020, still active until 2036") rather than just printing raw JSON — this is the main value sellers want.
